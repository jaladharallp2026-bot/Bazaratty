// Mock dataset for the Bazaratty prototype.
const CATEGORIES = [
...
// 14-day series for sparklines / charts
const SERIES_REV  = [42, 38, 51, 47, 60, 58, 64, 70, 66, 78, 74, 88, 92, 104];
const SERIES_ORD  = [12, 14, 11, 18, 16, 22, 19, 24, 26, 22, 28, 31, 30, 35];
const SERIES_PVW  = [220,260,240,310,290,360,420,380,460,490,520,560,610,680];
const SERIES_USR  = [ 8,  9, 12, 11, 15, 14, 18, 22, 20, 25, 27, 30, 32, 38];

// 12-month series for monthly charts
const SERIES_REV_12M = [22, 28, 31, 36, 42, 48, 55, 61, 70, 82, 96, 118];

// Curated Unsplash photo URLs — products, lifestyle, hero. Hot-linked at 800w.
const PHOTOS = {
...
// Map by product id for convenience
const PRODUCT_PHOTO = {
