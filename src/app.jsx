...
function App() {
  ...
  // Floating role/page jumper — small persistent control to navigate the prototype.
  const Jumper = () => {
        ...
        {open && (
          <div className="card" style={{ width: 320, marginBottom: 10, padding: 6, boxShadow: "var(--shadow-lg)", maxHeight: 540, overflow: "auto" }}>
            <div style={{ padding: "10px 12px 6px" }}>
              ...
              <div className="muted" style={{ fontSize: 11.5 }}>Prototype navigation · {Object.values(groups).reduce((a,g) => a + g.items.length, 0)} screens</div>
            </div>
            {groups.map(g => (
